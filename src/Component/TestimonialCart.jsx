...
const TestimonialCart = ({ img, comment, name }) => {
  return (
    <div className="p-3 -translate-x-10 lg:-translate-x-0">
      <div className=" max-w-[350px] h-[244px] p-8 rounded-md mx-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] bg-white relative my-12 bg-customPrimary bg-opacity-10 ">
